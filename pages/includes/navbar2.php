...
<nav class="sidebar" id="sidebar">
    ...
    <div class="nav-menu">
        <a href="../../dashboard/" class="nav-item <?php if ($currentPage === 'dashboard') echo 'active'; ?>">
        ...
        <div class="nav-dropdown <?php if (in_array($currentPage, ['patient_consultation','vital_signs','medical_records','nursing_notes'])) echo 'active'; ?>">
            ...
            <div class="dropdown-content">
                <a href="../patient_consultation/" class="<?php if ($currentPage === 'patient_consultation') echo 'active'; ?>">Patient Consultation</a>
                <a href="../vital_signs/" class="<?php if ($currentPage === 'vital_signs') echo 'active'; ?>">Vital Signs</a>
                <a href="../medical_records/" class="<?php if ($currentPage === 'medical_records') echo 'active'; ?>">Medical Records</a>
                <a href="../nursing_notes/" class="<?php if ($currentPage === 'nursing_notes') echo 'active'; ?>">Nursing Notes</a>
            </div>
        </div>

        <a href="../../medicines/" class="nav-item <?php if ($currentPage === 'medicines') echo 'active'; ?>">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <a href="../../supplies/" class="nav-item <?php if ($currentPage === 'supplies') echo 'active'; ?>">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <a href="../../equipment/" class="nav-item <?php if ($currentPage === 'equipment') echo 'active'; ?>">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
